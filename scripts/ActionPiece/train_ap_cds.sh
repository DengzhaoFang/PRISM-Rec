...
# Configuration
# ============================================================
DATASET="cds"  # Options: beauty, sports, toys, cds
...
N_HASH_BUCKETS=256    # For collision handling (ensures unique semantic IDs)
                      # Increased from 128 to 256 to handle max collision of 141 in CDs dataset
