...
class TrainingConfig:
    ...
    temperature: float = 1.0  # Temperature for Softmax (0.8-1.0 recommended)
...
def _create_dataset_config(
    ...
    **kwargs
    ...
    if output_dir is None:
        ...
        if output_keywords:
            output_dir = f"scripts/output/recommender/letter/{dataset_name}/{timestamp}_{output_keywords}"
        else:
            output_dir = f"scripts/output/recommender/letter/{dataset_name}/{timestamp}"
...
def get_beauty_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/letter_tokenizer/beauty/3-256-32/semantic_id_mappings.json"
    }
...
def get_sports_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/letter_tokenizer/sports/3-256-32/semantic_id_mappings.json"
    }
...
def get_toys_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/letter_tokenizer/toys/3-256-32/semantic_id_mappings.json"
    }
...
def get_cds_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/letter_tokenizer/cds/3-256-32/semantic_id_mappings.json"
    }
