...
class TIGER(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            temperature: Temperature for Ranking-guided Generation Loss
        
        Returns:
            Tuple of (loss, logits)
        """
        # T5ForConditionalGeneration automatically shifts labels for decoder_input_ids
        outputs = self.model(
            input_ids=input_ids,
        ...
        if labels is not None:
            ...
            # Smaller temperature (< 1.0) makes distribution sharper, focusing on top-k ranking
            scaled_logits = logits / temperature
            
            # Compute CrossEntropyLoss
            # T5 uses -100 as default ignore_index
