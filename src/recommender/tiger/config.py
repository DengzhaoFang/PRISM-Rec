...
def _create_dataset_config(
    ...
    **kwargs
    ...
    if model_type in ["t5-small", "t5-micro"]:
...
def get_sports_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/tiger_tokenizer/sports/3-256-32-ema/semantic_id_mappings.json"
    }
...
def get_toys_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'semantic_mapping_path': "scripts/output/tiger_tokenizer/toys/3-256-32-ema/semantic_id_mappings.json"
    }
