...
Generate semantic IDs from trained HID-VAE model and analyze:
...
from HID_VAE import HIDVAE
from multimodal_dataset import HIDVAEDataset


class SemanticIDGenerator:
    """Generate and analyze semantic IDs from trained HID-VAE"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Generate and analyze semantic IDs from trained HID-VAE'
    )
